...
Making mistakes is usually fine, and very fixable, as long as you follow some
basic rules.
...
Oops! I forgot some changes

```{bash}
echo "more changes" > another-new-file.txt
git commit -a --amend -m "Add new-file.txt and another-new-file.txt"
```

...
Before changes are committed, they need to be staged, or added to the staging
area/index.

After files are committed, they're now part of the local repository.

When commits are pushed, all of the objects (files, directories) are copied
